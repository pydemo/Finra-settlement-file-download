...
Usage:
  ...
  --url 	 : HTTP endpoint 
  --settlement_date : file date for download
  --show_url : just show URL containing SETTLEMENT_DATE (without download)
...
def url_read(url):
	try:
		...
		exit_status['HTTPException']=str(e.reason)	
...
EXIT_SUCCESS 	= 0
EXIT_FAILED 	=1
DEFAULT_SETTLEMENT_DATE_FORMAT ="%d-%b-%Y"
